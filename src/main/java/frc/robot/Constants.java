...
public class Constants {
  ...
  public static class ShooterConstants {
    ...
    public static final int ShooterMotorID = 49; //10 needs to move in reverse
    public static final int ShooterMotorID2 = 50;
  ...
  public static class NeckWheelConstants {
    ...
    public static double NeckWheelSpeed = 0.80;
  }
