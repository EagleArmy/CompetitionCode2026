...
public class CANdleSubsystem extends SubsystemBase {
    //private final CANdle m_candle = new CANdle(LEDConstants.CANdleID, "swerveCAN");  //Practice Robot
    private final CANdle m_candle = new CANdle(LEDConstants.CANdleID);                 //Official Robot
    ...
    public CANdleSubsystem(CommandXboxController joy) {
        this.joystick = joy;
        changeAnimation(AnimationTypes.SetAll);
        CANdleConfiguration configAll = new CANdleConfiguration();
        configAll.statusLedOffWhenActive = true;
        configAll.disableWhenLOS = false;  //was false
    ...
    public void incrementAnimation() {
        switch(m_currentAnimation) {
            ...
            case TwinkleOff: changeAnimation(AnimationTypes.SolidRed); break;
            case SolidRed: changeAnimation(AnimationTypes.SolidGreen); break;     //added
            case SolidGreen: changeAnimation(AnimationTypes.SolidBlue); break;   //added
            case SolidBlue: changeAnimation(AnimationTypes.SetAll); break;
            case SetAll: changeAnimation(AnimationTypes.RgbFade); break;
        }
    }
    public void decrementAnimation() {
        switch(m_currentAnimation) {
            // case ColorFlow: changeAnimation(AnimationTypes.SolidBlue); break;
            ...
            case RgbFade: changeAnimation(AnimationTypes.SolidBlue); break;
            ...
            case SolidRed: changeAnimation(AnimationTypes.TwinkleOff); break;     //added
            case SolidGreen: changeAnimation(AnimationTypes.SolidRed); break;   //added
            case SolidBlue: changeAnimation(AnimationTypes.SolidGreen); break;
            case SetAll: changeAnimation(AnimationTypes.SingleFade); break;
        }
    }
    ...
    public void changeAnimation(AnimationTypes toChange) {
        ...
        switch(toChange)
        {
            ...
            case TwinkleOff:
                ...
                break;
            case SolidRed:
                m_toAnimate = new SingleFadeAnimation(255, 0, 0, 0, 2, LedCount);
                break;
            case SolidGreen: 
                m_toAnimate = new  SingleFadeAnimation(0, 255, 0, 0, 2, LedCount);
                break;
            case SolidBlue: 
                m_toAnimate = new  SingleFadeAnimation(0, 0, 255, 0, 2, LedCount);
                break;
            case SetAll:
                m_toAnimate = null;
                break;
    ...
    public void changeLEDsBlue(){
        m_candle.setLEDs(0, 0, 255);
    }

    public void changeLEDsRed(){
